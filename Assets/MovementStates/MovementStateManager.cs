...
public class MovementStateManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        StarterAssetsInputs _input = GetComponent<StarterAssetsInputs>();
        ...
        void Update()
        {
            ...
            anim.SetFloat("Horiz", horizontalInput);
        ...
        void SwitchState(MovementBaseState state)
        {
            currentState = state;
        ...
        void SetRotateOnMove(bool newRotateOnMove)
        {
        ...
        void OnDrawGizmos()
        {
            ...
            Gizmos.DrawSphere(spherePosition, characterController.radius - 0.05f);
        }
    }
}
